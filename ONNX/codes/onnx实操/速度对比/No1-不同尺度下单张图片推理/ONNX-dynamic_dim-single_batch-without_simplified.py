...
parser.add_argument('--desc', type=str, default='[Dynamic_axis][No_simplified][Single-batch]', help='The description of this test')
parser.add_argument('--warm-up', type=str, default='no', help='model warm-up')
parser.add_argument('--verbose', action='store_true', help='')
args = parser.parse_args()  # 解析命令行参数

onnx_weights_path = 'ONNX/saves/model-dynamic_dims.onnx'
# ==============================================================================
# 加载 ONNX 模型，创建推理会话
